...
INSERT ALL
INTO Items (seller_Id,title,description,start_price,start_bidding_date,buy_it_now) VALUES('1','title1','description1','100',TO_DATE('01.01.2017', 'DD.MM.YYYY'),'0')
...
INTO Items (seller_Id,title,description,start_price,start_bidding_date,buy_it_now) VALUES('2','title3','description3','300',TO_DATE('01.01.2017', 'DD.MM.YYYY'),'0')
